...
Examples:
  ...
  %(prog)s --help
    ...
    parser.add_argument(
        'input_file',
        nargs='?',
        default='service/gracenote/channels.json',
        help='Input JSON file with channel data (default: service/gracenote/channels.json)'
    )
    parser.add_argument(
        '-o', '--output',
        default='guide/gracenote.xml',
        help='Output XML file (default: guide/gracenote.xml)'
    )
