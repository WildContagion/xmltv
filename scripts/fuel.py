...
def main():
    ...
    parser.add_argument('input_file', nargs='?', default='channels.json',
                       help='JSON file containing channel information (default: channels.json)')
    parser.add_argument('-o', '--output', default='epg.xml',
                       help='Output XML file (default: epg.xml)')
